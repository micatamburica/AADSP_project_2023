...
def get_inputs():
    ...
    inputs = [os.path.join(input_streams_root, x) for x in ['funky_sample.wav', 'speech_2ch.wav', 'Tone_L1k_R3k.wav']]
...
def get_params():
    ...
    params = [
        [0, 1],					                # Enable
        ["0.999", "-0.999", "0.501187"],	    # Input gain
        ["0.999", "-0.999", "0.707946"], 	    # Headroom gain
        ["3_2_0", "2_0_0", "0_2_0"]             # Output mode
    ]
